    ...
    <div
      ...
      <div className="max-h-screen h-screen bg-no-repeat bg-top text-white w-full md:p-20 p-10 md:grid md:grid-cols-2 md:grid-rows-1 grid grid-rows-2 gap-y-8">
        <div className="overflow-auto">
          <p
            className={clsx(
              `md:text-[5rem] text-lg  font-bold tracking-wide font-custom leading-normal`,
              (data?.name?.length || 0) >= 15 && 'md:text-[4rem] text-lg leading-none',
            )}>
            {data?.name}
          </p>
          <p className="text-lg tracking-wide md:w-[60%] w-full md:text-ellipsis">
        ...
        <div
          ...
          <div
            className={clsx('absolute inset-0 diagonal bg-contain bg-left-top bg-no-repeat', {
          ...
          <div
            className={twMerge(
              clsx('absolute inset-0 diagonal-reverse bg-right-top bg-no-repeat bg-contain', {
